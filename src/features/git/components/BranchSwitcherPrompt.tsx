        ...
        renderMeta={(branch) => {
          ...
          return (
            <span className="branch-switcher-modal-item-meta">
              {isCurrent && (
                <span className="branch-switcher-modal-item-current">{t("current")}</span>
              )}
              {worktree && (
                <span className="branch-switcher-modal-item-worktree">{t("worktree")}</span>
              )}
            </span>
          );
        }}
